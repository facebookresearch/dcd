...
parser.add_argument(
    "--gamma", type=float, default=0.995, help="Discount factor for rewards."
)
parser.add_argument(
    "--use_gae",
    type=str2bool,
...
parser.add_argument(
    "--max_grad_norm", type=float, default=0.5, help="Max norm of student gradients."
)
parser.add_argument(
    "--adv_max_grad_norm",
    type=float,
...
parser.add_argument("--seed", type=int, default=1, help="Experiment random seed.")
parser.add_argument(
    "--num_processes",
    type=int,
    default=32,
...
parser.add_argument("--ppo_epoch", type=int, default=5, help="Number of PPO epochs.")
parser.add_argument(
    "--adv_ppo_epoch", type=int, default=5, help="Number of PPO epochs used by teacher."
)
parser.add_argument(
    "--num_mini_batch",
    type=int,
...
parser.add_argument(
    "--clip_param", type=float, default=0.2, help="PPO advantage clipping."
)
parser.add_argument(
    "--clip_value_loss", type=str2bool, default=True, help="PPO value loss clipping."
)
parser.add_argument(
    "--clip_reward",
    type=float,
...
parser.add_argument(
    ...
    type=str,
    default="paired",
    choices=["domain_randomization", "minimax", "paired", "flexible_paired", "alp_gmm"],
    help="UED algorithm",
)
parser.add_argument(
    "--protagonist_plr",
...
parser.add_argument(
    "--staleness_coef", type=float, default=0.3, help="Staleness-sampling weighting."
)
parser.add_argument(
    "--staleness_transform",
    type=str,
...
parser.add_argument(
    "--model_finetune", default="model", help="Name of .tar to load for fine-tuning."
)
